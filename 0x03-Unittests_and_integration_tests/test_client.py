#!/usr/bin/env python3
"""Defines a module client module
"""
import unittest
...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, organization: str, mock: unittest.mock.patch):
        """
        Test the org request to ensure
        :return: Nothing
        """
    ...
    def test_public_repos_url(self):
        """ Test public organization repossitory """
        with patch.object(
    ...
    def test_public_repos(self, mock_json):
        """
        Test public repository function
        """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self):
        """ Integration test: public repository """
